 ...
 * @author Adrian
 */
public class PantallaPrincipal11 extends javax.swing.JFrame {
    /**
     * Creates new form PantallaPrincipal
     */
    public PantallaPrincipal11() { 
         try {
...
if (confirmacion == JOptionPane.YES_OPTION) {
   ...
   // mostrarLogin();
    ...
    //    boolean eliminado = dao.eliminar(usuarios);
...
//this.add(bkgprincipalform, BorderLayout.CENTER);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaPrincipal11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PantallaPrincipal11().setVisible(true);
        });
    }
